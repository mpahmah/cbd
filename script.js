...
new TypeIt("#teks1", {
  strings: ["Hei gaes", " ", "Tahun 2022 kira-kira apa warna rambutmu?", " ", "<b>warnai saja dengan CBD PROFESSIONAL</b>", " ", "Ada banyak pilihan Pewarna rambut,tentunya pas buat gaya rambut kamu ditahun baru.", , " ", "ayo warnai rambutmu", " ", "- asep wijaya :)"],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["produk kami", "SUDAH TERUJI DAN MUDAH DIDAPATKAN", " ", "Colormax,developer,conditior,keratin,hairmask,shampoo,vitamin", "ada banyak pilihan untuk mempersiapkan gaya rambut menyambut tahun baru:)", "buat penampilan rambutmu berbeda,kami siap membantu"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
